...
sys.path.append("./bruinbot/deeplabv3")
...
sys.path.append("./bruinbot/deeplabv3/model")
from deeplabv3 import DeepLabV3

sys.path.append("./bruinbot/deeplabv3/utils")
...
network = DeepLabV3("eval_val_for_metrics", project_dir="./bruinbot/deeplabv3").cuda()
network.load_state_dict(torch.load("./bruinbot/deeplabv3/pretrained_models/model_13_2_2_2_epoch_580.pth"))

val_dataset = DatasetVal(cityscapes_data_path="./bruinbot/deeplabv3/data/cityscapes",
                         cityscapes_meta_path="./bruinbot/deeplabv3/data/cityscapes/meta")
...
with open("./bruinbot/deeplabv3/data/cityscapes/meta/class_weights.pkl", "rb") as file: # (needed for python3)
